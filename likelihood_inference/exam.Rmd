...
mus = seq(19.5,21,length=100)
k = seq(5,45,length=100)
...
a = 4
as = c()
ns = c(10,50,100,250,500,750,1000,1500,2000)
#m = fitdistr(data,"weibull")
for (i in 1:length(ns)){
  n = ns[i]
  data = rweibull(n,4,17)
  print(n)
  ...
  ML = optim(c(15,3),function(x)-log_likeli(x))$par
  as = append(as,ML[2])
}
